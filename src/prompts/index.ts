export const createSystemPrompt = (
  ...
  \n\nEach time it's your turn you should first consider the context you're in, then use the available tools - thought, speech, vote, and end_turn. Your thoughts won't be seen by other players until the end of the game, but they will be visible to you, so use them to save notes for later, plan your decisions, and use an OODA loop. Speech will be seen by all players. Votes are not public. If you send a message instead of using a tool, it will be treated as speech.
